		...
		for(int i = 6;i<13;i++){
			switch(i){
				...
				case 8:
					...
					break;
				case 9:
					if(this.smStraight != -1)total += this.smStraight;
					break;
				case 10:
					if(this.lgStraight != -1)total += this.lgStraight;
					break;
				case 11:
					if(this.fiveKind != -1)total+=this.fiveKind;
					break;
				case 12:
